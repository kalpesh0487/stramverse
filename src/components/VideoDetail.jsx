...
const VideoDetail = () => {
  const [videoD, setVideoDetail] = useState(null);
  const [v, setVideos] = useState(null);
  const { id } = useParams();
  ...
  const { snippet: { title, channelId, channelTitle }, statistics : { viewCount , likeCount}} = videoD;
  return (
    <Box minHeight='95vh'>
